-- v4: ergänzt 'kpis' (Team-Schnitt je KPI + Band) in der Situation. Damit zeigt der Anstoß die Zahlen AUCH
--     wenn niemand schwach/stark ist (Lage "ok"): wie stehen die Kennzahlen im Schnitt. Rest wie v3.
