...
const ALLOW = new Set(['activity_log', 'akquise']);   // ohne Katalog-Eintrag: activity_log (eigener Rollenfilter); akquise (Sales-Freigabeliste, nicht über die Tab-Matrix sperrbar)
